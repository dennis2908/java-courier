...
public class searchOK extends KeyAdapter
{
	...
	@SuppressWarnings("rawtypes")
	public searchOK(JTextField txtFieldParam)
	{
	...
	public void databaseNama()
	{
		try
		{
			...
			String query = "SELECT ZonaA,ZonaB,ZonaC FROM OKServ INNER JOIN OKServ ON Wilayah.Kode = OKServ.Kode";
