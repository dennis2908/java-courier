...
public class DialogOKServ extends JDialog 
{
	...
	public DialogOKServ() 
	{
		...
		tabel.addMouseListener(new MouseAdapter()
		{
			...
			public void mouseClicked(MouseEvent me) 
			{
				...
				String kodeOK = (String) tabelModel.getValueAt(pilih, 0);
				zt.txtKodeOK.setText(kodeOK);
				String kotamadyaOK = (String) tabelModel.getValueAt(pilih, 1);
				zt.txtKotamadyaOK.setText(kotamadyaOK);
				String propinsiOK = (String) tabelModel.getValueAt(pilih, 2);
				zt.txtPropinsiOK.setText(propinsiOK);
				dispose();
				zt.tabbedPane.setSelectedIndex(1);
			}
		});
