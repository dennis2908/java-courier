...
public class searchYes extends KeyAdapter
{
	...
	@SuppressWarnings("rawtypes")
	public searchYes(JTextField txtFieldParam)
	{
	...
	public void databaseNama()
	{
		try
		{
			...
			String query = "SELECT TarifYes FROM YesServ INNER JOIN YesServ ON Wilayah.Kode = YesServ.Kode";
