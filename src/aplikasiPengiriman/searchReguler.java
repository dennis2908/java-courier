...
public class searchReguler extends KeyAdapter
{
	...
	@SuppressWarnings("rawtypes")
	public searchReguler(JTextField txtFieldParam)
	{
	...
	public void databaseNama()
	{
		try
		{
			...
			String query = "SELECT ZonaA,ZonaB,ZonaC,ZonaD FROM RegulerServ INNER JOIN RegulerServ ON Wilayah.Kode = RegulerServ.Kode";
